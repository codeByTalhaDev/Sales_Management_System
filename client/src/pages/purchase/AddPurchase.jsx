        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl w-full max-w-3xl p-6 shadow-xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-5">
              ...
              <button onClick={handleCloseSlip} className="cursor-pointer">
                <X />
              </button>
            </div>
            ...
            <div className="ml-auto max-w-sm bg-slate-50 rounded-xl p-4 space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <strong>Rs. {slip.totalAmount.toFixed(2)}</strong>
              </div>

              <div className="flex justify-between">
                <span>Paid Amount</span>
                <strong>Rs. {slip.paidAmount.toFixed(2)}</strong>
              </div>

              <div className="flex justify-between border-t pt-3">
                <span>Remaining</span>
                <strong className="text-red-600">
                  Rs. {slip.remainingBalance.toFixed(2)}
                </strong>
              </div>
            </div>
