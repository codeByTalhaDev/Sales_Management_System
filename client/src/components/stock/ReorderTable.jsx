...
const ReorderTable = ({ products, loading }) => {
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <p className="text-gray-500">Loading reorder products...</p>
      </div>
    );
  }
        ...
        <table className="w-full min-w-[850px] text-sm">
          <thead className="bg-orange-50">
            <tr className="text-left text-gray-700">
              ...
              <th className={cellClass}>Needed Qty</th>
          ...
          <tbody>
            {products.length === 0 ? (
              ...
              paginatedProducts.map((item, index) => {
                ...
                const neededQuantity = Math.max(reorderQuantity - quantity, 0);
                ...
                return (
                  ...
                  >
                    ...
                    <td className={cellClass}>{reorderQuantity}</td>

                    <td className={cellClass}>{neededQuantity}</td>
